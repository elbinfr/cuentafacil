...
@section('script-plugins')
    <script src="{{ asset('plugins/template/vendors/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('plugins/template/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js') }}"></script>
    <script src="{{ asset('plugins/template/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
    <script src="{{ asset('plugins/template/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
@endsection

@section('script')
    <script src="{{ asset('plugins/template/js/scripts/dashboard_visitors.js') }}"></script>
@endsection